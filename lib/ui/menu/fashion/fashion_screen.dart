...
import 'package:thought_factory/state/state_filter.dart';
...
class _FashionScreenState extends State<FashionScreen> {
  ...
  StateFilter _stateFilter = StateFilter(
      selectedFilterItem: AppConstants.BRAND,
      priceAvailable: true,
      brandAvailable: false,
      colorAvailable: true,
      sizeAvailable: true,
      brandObj: BrandObject(selectedBrandsList: null, brandList: null, brandCheckBoxList: {
        'Puma': false, 'Adidas': false, 'RayMan': false,
//                              'Reebok': false,'Nike': false,'Glisy': false,
//                              'Wrisk': false,'Nike': false,'Glisy': false,
        'Fisik': false, 'Diskin': false, 'Alen Solly': false,
      }),
      sizeObj: SizeObject(sizeList: null, selectedSizeList: null),
      colorObj: ColorObject(colorList: null, selectedColorsList: null),
      priceObj: PriceObject(maxPrice: 100, minPrice: 5, selectedMinPrice: 7, selectedMaxPrice: 90));
            ...
            child: Row(
              children: <Widget>[
                ...
                RawMaterialButton(
                  ...
                  onPressed: () {
                    _navigateToFilterPageAndPassData(context);
                    //Navigator.pushNamed(context, BuildFilterScreen.routeName);
                  },
                  child: Icon(
                    Icons.filter_list,
                    color: colorBlack,
  ...
  _navigateToFilterPageAndPassData(BuildContext context) async {
    // Navigator.push returns a Future that completes after calling
    // Navigator.pop on the Selection Screen.
    _stateFilter = await Navigator.push(
      context,
      //MaterialPageRoute(builder: (context) => BuildFilterScreen(_stateFilter)),
      MaterialPageRoute(builder: (context) => BuildFilterScreen()),
    );
    print(_stateFilter.toString());
  }
