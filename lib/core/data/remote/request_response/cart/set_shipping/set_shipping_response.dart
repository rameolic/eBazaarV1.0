...
class SetShippingMethodResponse {
  List<PaymentMethods> paymentMethods;
  Totals totals;
  String message;
  int status;

  SetShippingMethodResponse({this.paymentMethods, this.totals, this.message, this.status});

  SetShippingMethodResponse.fromJson(Map<String, dynamic> json) {
  ...
  SetShippingMethodResponse.fromErrorJson(Map<String, dynamic> json) {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.paymentMethods != null) {
      data['payment_methods'] = this.paymentMethods.map((v) => v.toJson()).toList();
    }
    if (this.totals != null) {
